<template>
  <div class="menupage">
    <el-menu
      ...
      <p class="logo-title"><i class="el-icon-user"></i>Xiao Feng Huang</p>
      <el-menu-item index="1" style="margin-left:280px;">Home</el-menu-item>
      <el-menu-item index="2">About Me</el-menu-item>
      <el-menu-item index="3">Skills</el-menu-item>
      <el-menu-item index="4">Work Experience</el-menu-item>
    </el-menu>
  </div>
</template>
